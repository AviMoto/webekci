...
<th align=left>Alerts</th>
   ...
   <tr bgcolor="{cycle values="#eeeeee,#dddddd"}">
	 <td><a href="javascript:void(0);" OnClick="WindowOpen('reports.php?tab=rule&cmd=show_rule&rule_id={$data[alog].rule_id}');">
	{html_image file='web/images/edit.gif' border='0'}
	</a></td>
         <td>{$data[alog].rule_id}</td>
         <td>{$data[alog].rule_id_count}</td>
      </tr>
   {/section}
</table>
